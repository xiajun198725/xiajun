...
SUPEE-1868 | EE_1.13.0.1 | v1 | 881d5fb7645a68b84e9b271a732595e7091bd6cb | Fri Jul 26 13:12:11 2013 -0700 | v1.13.0.1..HEAD

__PATCHFILE_FOLLOWS__
diff --git app/code/core/Mage/Paypal/Model/Express/Checkout.php app/code/core/Mage/Paypal/Model/Express/Checkout.php
index 84f087a..f060e16 100644
...
@@ -444,76 +444,51 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
...
@@ -525,12 +500,16 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
...
+                );
                 ...
                 $rate->setPrice($price);
                 $result->append($rate);
@@ -547,66 +526,110 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
      * @param string $code
      * @return array|bool
      */
...
@@ -617,8 +640,8 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
...
@@ -629,34 +652,48 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
                     'filters'    => array(
                         'within_us' => array(
                             'method' => array(
...
@@ -670,6 +707,10 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
                                 'Priority Mail Large Flat Rate Box',
                                 'Priority Mail Medium Flat Rate Box',
                                 'Priority Mail Small Flat Rate Box',
+                                'Priority Mail International Large Flat Rate Box',
...
+                                'Priority Mail Express Sunday/Holiday Delivery Flat Rate Boxes',
                         ...
                         'from_us' => array(
@@ -686,15 +727,22 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
                     'filters'    => array(
                         'within_us' => array(
                             'method' => array(
-                                'Express Mail Flat Rate Envelope',
...
@@ -704,20 +752,19 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
                     'filters'    => array(
                         'within_us' => array(
                             'method' => array(
-                                'Express Mail',
...
@@ -728,27 +775,25 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
                     'filters'    => array(
                         'within_us' => array(
                             'method' => array(
-                                'Express Mail',
...
@@ -766,13 +811,6 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
             ),
         );
...
@@ -789,18 +827,18 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
     /**
      * Get tracking
      *
...
@@ -810,7 +848,7 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
      *
      * @return null
      */
...
@@ -823,14 +861,13 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
     /**
...
@@ -868,11 +905,11 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
     /**
...
+    protected function _parseXmlTrackingResponse($trackingValue, $response)
     {
         ...
         $resultArr=array();
@@ -903,20 +940,19 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
         if (!$this->_result) {
...
@@ -931,8 +967,8 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
     {
         $statuses = '';
...
@@ -959,7 +995,7 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
...
@@ -1292,27 +1328,32 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
      *
...
+            case 'Library':
                 ...
                 break;
             default:
@@ -1631,7 +1672,7 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
...
@@ -1641,10 +1682,10 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
             } else {
...
@@ -1674,7 +1715,7 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
...
@@ -1814,37 +1855,15 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
     }
...
+     * @deprecated
     ...
     {
@@ -1852,13 +1871,18 @@ class Mage_Usa_Model_Shipping_Carrier_Usps
     }
...
index 4dbb025..2948e6e 100644
--- app/code/core/Mage/Usa/Model/Shipping/Carrier/Usps/Source/Method.php
+++ app/code/core/Mage/Usa/Model/Shipping/Carrier/Usps/Source/Method.php
@@ -32,8 +32,8 @@ class Mage_Usa_Model_Shipping_Carrier_Usps_Source_Method
